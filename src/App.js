...
class App extends Component {
  ...
  async loadWallet() {
    walletLinkProvider.enable().then((accounts) => {
      console.log(`User's address is ${accounts[0]}`)
      web3.eth.defaultAccount = accounts[0];
      this.loadBlockchainData(this);
    });
  }
  

  async loadBlockchainData(x) {
    ...
    let exchangeRate = await tokenContract.methods.exchangeRateStored().call();
    let exchangeRateToEth = web3.utils.fromWei(exchangeRate.toString(), 'ether');
    exchangeRate = exchangeRate / Math.pow(10, 18);
    balance = balance / Math.pow(10, decimals);
    balance = balance * exchangeRateToEth;
    console.log('Here');
  ...
  render() {
    return (
      <div>
        <Navbar>
        <Navbar.Header>Saturn Fi</Navbar.Header>
        <Navbar.Body>
          <Button size="lg" onClick={this.handleClick}>Connect Wallet</Button>
        ...
        <Col>
          ...
          <div className="container">
            <Col>
            <p className='balance'>Cream USDC</p>
              <p className='balance'>${this.state.balance}</p>
              <Container fluid>
              <Row sm={2}>
                <Col>
                  <div className="deposit">
                    <text className="depositText">Depsoit</text>
                  </div>
                </Col>
                <Col>
                ...
                <Col>
                  <div className="withdraw">
                    <text className="withdrawText">Withdraw</text>
                  </div>
                </Col>
              </Row>
              </Container>
        ...
        <Col>
          <div className="container">
            <Col>
            <p className='balance'>Aave USDC</p>
              <p className='balance'>${this.state.balance}</p>
              <Row sm={2}>
                <Col>
                  <div className="deposit">
